...
%                 end
                ...
                %switch community_detection
                    ...
                    %case 'infomap'
                        ...
                        disp(['running community detection with command: cifti_community_detection_RH(' temp_name ',' path_dist_matrix ',' template ',' num2str(min_distance) ',' num2str(tie_density) ',' num2str(min_network_size) ',' num2str(min_region_size) ',' community_detection ',' num2str(num_reps) ')']);
                        [ info_output_cifti_scalar_name] = cifti_community_detection_RH(temp_name,path_dist_matrix,template,min_distance,tie_density,min_network_size,min_region_size,'infomap',num_reps);
            ...
            if exist([dscalar_out_dir '/' output_cifti_scalar_name],'file') == 0
                ...
                switch community_detection
                    ...
                    case 'infomap'
                        ...
                        path_dist_matrix = '/home/exacloud/lustre1/fnl_lab/code/internal/utilities/community_detection/fair/supporting_files/EUGEODistancematrix_XYZ_255interhem_unit8.mat';
                        disp(['running community detection with command: cifti_community_detection_RH(' temp_name ',' path_dist_matrix ',' template ',' num2str(min_distance) ',' num2str(tie_density) ',' num2str(min_network_size) ',' num2str(min_region_size) ',' community_detection ',' num2str(num_reps) ')']);
                        [ output_cifti_scalar_name] = cifti_community_detection_RH(temp_name,path_dist_matrix,template,min_distance,tie_density,min_network_size,min_region_size,community_detection,num_reps);
