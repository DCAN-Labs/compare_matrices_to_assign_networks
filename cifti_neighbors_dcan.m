function neighbors = cifti_neighbors_dcan(ciftifile,volneighbor_method,separate_structures,path_to_neighbors)
...
size_cifti_data=size(cifti.data,1);
cifti.data= [];

bufsize=16384;
% if exist('path_to_neighbors','var') ==1
