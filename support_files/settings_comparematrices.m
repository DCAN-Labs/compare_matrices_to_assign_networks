...
try
    ...
    pathparts=strsplit(server_name,'/');
    if strcmp(pathparts{2},'tmp') ==1
        server_name='/tmp';
    end
    if strcmp(pathparts{2},'users') ==1
        server_name='/users';
    end
    if strcmp(pathparts{2},'projects') ==1
...
switch server_name
    ...
    case '/home/fair' %mesabi
        ...
        path{4}='/projects/standard/faird/shared/code/internal/utilities/hcp_comm_det_damien/Gordan_subcortical_template_ptseries.conc_AVG.pconn.nii';
        %templates:
        path{5}='/projects/standard/faird/shared/code/internal/utilities/community_detection/fair/supporting_files/Networks_template_cleaned.pscalar.nii';
        path{6}='/projects/standard/faird/shared/code/internal/analytics/compare_matrices_to_assign_networks/support_files/Networks_template_cleaned.dscalar.nii';
        path{7}='/projects/standard/faird/shared/code/internal/utilities/community_detection/fair/supporting_files/120_LR_minsize400_recolored_manualconsensus4.dconn.nii';
        path{8}='/projects/standard/faird/shared/code/internal/analytics/compare_matrices_to_assign_networks/support_files/91282_Greyordinates.dscalar.nii';
        path{9}='/projects/standard/faird/shared/code/internal/utilities/hcp_comm_det_damien/Merged_HCP_best80_dtseries.conc_AVG.dconn.nii';
        path{10}='/projects/standard/faird/shared/code/internal/analytics/compare_matrices_to_assign_networks/support_files/91282_Greyordinates.dtseries.nii';
        path{11}='/projects/standard/faird/shared/code/internal/analytics/compare_matrices_to_assign_networks/support_files/91282_Greyordinates_surf_only.dtseries.nii';
